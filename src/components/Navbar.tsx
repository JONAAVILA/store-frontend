...
export default function Navbar(){
    return(
        <aside className="flex items-center justify-between w-[1000px] gap-1 pb-2 mb-2">
            <div className="flex items-center justify-between w-[745px] text-[10px] p-1 border-2 rounded-3xl border-[var(--border)] bg-[var(--grey)] dark:text-[var(--primary)] dark:border-[var(--primary)]"
            >
            ...
            <div className="flex items-center justify-center gap-1 text-[10px] p-1 border-2 rounded-3xl border-[var(--border)] bg-[var(--grey)] dark:text-[var(--primary)] dark:border-[var(--primary)]"
            >
                <Store/>
                <Link href={"/auth"}>
                    <ButtonAction>
